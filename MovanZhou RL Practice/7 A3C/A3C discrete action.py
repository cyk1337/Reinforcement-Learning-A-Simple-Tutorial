...
class ACNet:
        ...
        if scope == GLOBAL_NET_SCOPE:
            ...
            with tf.variable_scope(scope):
                ...
                with tf.name_scope("a_loss"):
                    ...
                    entropy = -tf.reduce_sum(self.a_prob * tf.log(self.a_prob + 1e-5), axis=1, keepdims=True)
                    self.exp_v = ENTEROPY_BETA * entropy + exp_v
    ...
    def update_global(self, feed_dict):
        SESS.run([self.update_a_op, self.update_c_op], feed_dict)  # local grads apply to the global net
            ...
            while True:
                ...
                if done:
                    if len(GLOBAL_RUNNING_R) == 0:
                        ...
                        GLOBAL_RUNNING_R.append(.99 * GLOBAL_RUNNING_R[-1] + .01 * ep_r)
